...
from amr2lean import AMR2LeanTranslator
...
if __name__ == '__main__':
	...
	lean_saving_dir = base_dir + 'nli_amr2lean_frame_centric/'
	...
	for row in hypo_prem_pairing.itertuples():
		...
		with open(lean_saving_dir + 'sick-dev'+f'-{str(row.pair_ID)}.lean', 'w') as f:
			...
			hypo_leancode = t2.translate(amr2, 's1')
			...
			final_code = t1.M.render() + '\n\n' + extra_axiom_insertion_comment + t2.M.theorem_render(row.entailment_judgment == 'CONTRADICTION')
